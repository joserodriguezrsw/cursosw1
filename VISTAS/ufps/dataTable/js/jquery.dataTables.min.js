...
(function(h) {
    ...
    function nb(a) {
        var b = a.oClasses
          ...
          /*var responseTable = h('<div style="overflow-x: auto;max-width: 100%; width:100%;" class="table-responsive" ></div>')[0];
          responseTable.appendChild(a.nTable);
          a.nTable = responseTable;*/
